...
```
Tests failing (<failures> failures). Must fix before completing:
[Show failures]
...
1. Merge <feature-branch> back to <base-branch> locally
...
Report: "Keeping branch <feature-branch>. Worktree preserved at <path>."
