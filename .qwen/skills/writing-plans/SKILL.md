...
**Save plans to:** `docs/superpowers/plans/YYYY-MM-DD-<feature>.md` - (User preferences for plan location override this default)
...
**"Plan complete and saved to `docs/superpowers/plans/<feature>.md`. Two execution options:**
