...
- Smaller, well-bounded units are also easier for you to work with - you reason better about code you can hold in context at once, and your edits are more reliable when files are focused. When a file grows too large, that's often a signal that it's doing too much.
...
> "Spec written and committed to `docs/superpowers/specs/YYYY-MM-DD--design.md`. Please review it and let me know if you want to make any changes before we start writing out the implementation plan."
