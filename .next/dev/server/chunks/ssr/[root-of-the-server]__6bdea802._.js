...
const translations = {
    en: {
        ...
        "hero.description": "Specialized in Mobile & Web Solutions, IT Research Papers, AI-Powered Student Projects, and Professional Document Services",
        ...
        "services.mobile.description": "Cutting-edge mobile and web applications built with the latest technologies",
        "services.research.title": "IT Research Papers",
        "services.research.description": "Professional research papers and technical documentation for academic excellence",
        "services.projects.title": "Student Projects",
        "services.projects.description": "AI-powered student projects with innovative solutions and modern implementations",
        "services.documents.title": "Professional Documents",
        "services.documents.description": "Expert CV design and professional office document creation",
        // Projects
    ...
    ar: {
        ...
        "hero.description": "متخصصون في حلول الهاتف المحمول والويب، أوراق البحث التقني، مشاريع الطلاب بتقنيات الذكاء الاصطناعي، وخدمات المستندات الاحترافية",
        ...
        "services.mobile.description": "تطبيقات هاتف محمول وويب متطورة مبنية بأحدث التقنيات",
        "services.research.title": "أوراق البحث التقني",
        "services.research.description": "أوراق بحثية احترافية ووثائق تقنية للتميز الأكاديمي",
        "services.projects.title": "مشاريع الطلاب",
        "services.projects.description": "مشاريع طلابية مدعومة بالذكاء الاصطناعي مع حلول مبتكرة وتطبيقات حديثة",
        "services.documents.title": "المستندات الاحترافية",
        "services.documents.description": "تصميم السيرة الذاتية وإنشاء مستندات المكتب الاحترافية",
        // Projects
...
function LanguageProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const savedLang = localStorage.getItem("highfive_pref_lang");
        if (savedLang) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6bdea802._.js.map